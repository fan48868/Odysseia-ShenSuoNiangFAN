...
Odysseia 是一个为 Discord 社区"类脑"量身打造的、功能丰富的AI助手。其核心是拥有鲜明人设的AI"狮子娘"，她不仅能与社区成员进行富有个性的互动，还集成了一系列旨在提升社区活跃度、帮助新人融入的功能。
...
### 内置小游戏
- **二十一点 (Blackjack)**: 与"狮子娘"来一场刺激的牌局
- **抽鬼牌 (Ghost Card)**: 经典卡牌游戏，考验你的运气和策略

### 社区世界书 (World Book)
- **社区共建**: 这是一个由所有社区成员共同构建的知识库，记录着社区的文化、历史和梗
- **增量RAG**: "狮子娘"能够实时查询"世界书"中的内容，以更准确、更富背景知识地回答用户的问题
...
### 核心交互
- **自由聊天**: 在任何频道中 `@狮子娘` 或直接回复她的消息，即可开始对话
...
#### 💬 聊天相关
- **`/好感度`**: 查询你与狮子娘的好感度状态
- **`/投喂`**: 给狮子娘分享你的美食，可以提升好感度
- **`/忏悔`**: 向狮子娘忏悔，可能会影响你们的关系
