...
EMOJI_MAPPINGS = [
    ...
    (re.compile(r"\<吃瓜\>"), ["<:chu_gua:1485151671746166834>"]),
    ...
    (re.compile(r"\<打哈欠\>"), ["<:hao_kun:1491322759899516999>"]),
    (re.compile(r"\<收到\>"), ["<:shou_dao:1491322756841869484>"]),
    (re.compile(r"\<呜呜\>"), ["<:wu_wu:1491322753209598099>"]),
    (re.compile(r"\<裂开\>"), ["<:lie_kai:1491322750248288359>"]),
    (re.compile(r"\<得意\>"), ["<:de_yi:1491326007729197176>"]),
    (re.compile(r"\<点赞\>"), ["<:dian_zan:1491329809857646702>"]),
    (re.compile(r"\<眩晕\>"), ["<:xuan_yun:1491326013471195218>"]),
    (re.compile(r"\<疑惑\>"), ["<:yi_huo:1491326016428179597>"]),
    (re.compile(r"萝莉|幼女|正太|炼铜|恋童"), ["~~**[数据删除]**~~"]),
]
